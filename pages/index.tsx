		...
		<BasePageLayout>
			<div className='flex justify-between items-center'>
				<div className={styles.left}>
					<h3 className='text-white text-5xl font-extrabold text-center my-8 w-3/4 mx-auto'>
						Unlimited movies, TV shows, and more
					</h3>
					<p className='text-stone-600 text-2xl mt-16 text-center w-3/4 mx-auto'>
				...
				<div className={styles.right}>
					<h3 className='text-white text-5xl font-extrabold text-center my-8 w-full mx-auto'>
						Get rewarded for just being a loyal customer.
					</h3>
					<p className='text-stone-600 text-2xl mt-16 text-center w-full mx-auto'>
